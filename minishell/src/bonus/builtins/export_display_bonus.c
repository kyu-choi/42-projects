...
/**
 * @brief Prints one environment variable in export format
 * @param env Environment node to print
 * @details Prints as 'declare -x KEY="VALUE"' with proper escaping
 */
...
/**
 * @brief Prints all environment variables in export format (sorted)
 * @param env Environment linked list
 * @details Displays variables sorted alphabetically with 'declare -x' prefix
 */
